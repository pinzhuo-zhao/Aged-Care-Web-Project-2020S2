...
<br>
    ...
    <tr>
        ...
        <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="School: activate to sort column ascending" style="width: 150px;"><a>School</a></th>
        ...
        <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Year Level: activate to sort column ascending" style="width: 160px;"><a>Year Level</a></th>
    ...
    <tr>
        ...
        <td><?= h($this->Text->truncate($user['email'],15)) ?></td>
