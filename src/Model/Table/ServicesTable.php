...
class ServicesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('service_id')
            ->allowEmptyString('service_id', null, 'create')
            ->add('service_id', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
        ...
        $validator
            ->scalar('service_charge')
            ->maxLength('service_charge', 50)
            ->requirePresence('service_charge', 'create')
            ->notEmptyString('service_charge');
    ...
    {
        $rules->add($rules->isUnique(['service_id']));
